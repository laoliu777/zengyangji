...
<!-- 
			...
			<a class="btn btn-info" href="#" onclick="javascript:history.back(-1);">返回订单列表</a><br><br>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>订单物流填写</h2>
						<div class="box-icon">
					...
					<form  action="ItemEdit" method="post" onsubmit="return check(this);">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">						
							...
							<tr>
								...
								<input type = "text" name = "kdcompany" style="width:8rem;" value="<%=p.getKdcompany()%>" required="">
								<% } else {	 %>
								<input type = "text" name = "kdcompany" style="width:8rem;" required="">
								<% } %>	
								</td>							
							</tr>
							<tr>
								...
								<td class="center">
								<% if (p.getOrderstate()>0){	 %>
								<input type = "text" name = "kdno" style="width:8rem;" value="<%=p.getKdno()%>" required="">
								<% } else {	 %>
								<input type = "text" name = "kdno" style="width:8rem;" required="">
								<% } %>	
								</td>							
							</tr>								
