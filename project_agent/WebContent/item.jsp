	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>订单管理</h2>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <%						
								...
								for (Item p : list) {
									...
									String time=df.format(p.getOrdertime());
							%>		
							<tr>
								...
								<td class="center">
									<a class="btn btn-success" href="ItemDetail?oid=<%=roid %>">
										<i class="halflings-icon white zoom-in"></i>  
									</a>
									<% if (p.getOrderstate()==0){	 %>
									<a class="btn btn-info" href="ItemEditDetail?oid=<%=roid %>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<%	}  %>
									<!--  
									<form action="ItemDelete?oid=<%=roid %>"  method="post" id="myform"></form>																	
									<a class="btn btn-danger" href="#" onclick="return confirm ('确认?'),document.getElementById('myform').submit();return false;">
