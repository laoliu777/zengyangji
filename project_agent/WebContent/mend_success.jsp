...
<!-- 
		    ...
		    <button class="btn btn-primary" style="height:4rem;"onclick = "javascrtpt:window.location.href='MendServlet'">
		    <span class="glyphicon glyphicon-hand-left"><font size="4rem">&nbsp;返回报修报换界面&nbsp;&nbsp;</font></span></button>
