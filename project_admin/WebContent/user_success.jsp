...
<!-- start: Header -->
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
		    ...
		    <button class="btn btn-primary" style="height:4rem;"onclick = "javascrtpt:window.location.href='UserServlet'">
		    <span class="glyphicon glyphicon-hand-left"><font size="4rem">&nbsp;返回用户界面&nbsp;&nbsp;</font></span></button>
