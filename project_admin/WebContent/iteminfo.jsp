	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>设备型号管理</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						   <%						
								...
								for (Info p : list) {
									ii++;
									String rtype=p.getType();
							%>		
							<tr>
								<td class="center"><%=ii %></td>
								<td class="center"><%=p.getType()%></td>	
								<td class="center"><%=p.getZujing()%></td>															  			
								<td class="center"><%=p.getYajing()%></td>	
								<td class="center"><%=p.getShoujia()%></td>											
								<td class="center"><%=p.getBrand()%></td>	
								<td class="center"><%=p.getSpec()%></td>						  																				  								
								<td class="center">
									<a class="btn btn-info" href="InfoEditDetail?type=<%=rtype %>">
