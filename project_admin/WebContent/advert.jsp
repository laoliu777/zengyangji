	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>管理员后台管理系统</span></a>
	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>广告管理</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<%						
								List<Advert> list = (List<Advert>) request.getAttribute("list");
								for (Advert p : list) {
							...
							%>		
							<tr>
								<td class="center"><%=mmid %></td>
								<td class="center"><%=p.getAdtitle()%></td>	
								<td class="center"><%=p.getAdtime()%></td>															  						  								
								<td class="center">
									<a class="btn btn-success" href="AdvertDetail?advid=<%=aadvid %>">
										<i class="halflings-icon white zoom-in"></i>  
									</a>
									<a class="btn btn-info" href="AdvertEditDetail?advid=<%=aadvid %>">
