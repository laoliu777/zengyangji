			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="AdvertAdd1" class="form-horizontal" method="post" enctype="multipart/form-data" data-ajax="false">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">广告标题</label>
								<div class="controls">
								  <input class="input-xlarge focused" type="text" name="adtitle" required="">
								</div>
							  </div>
							  <div class="control-group">
								...
								<textarea style="width:500px;font-size:15px; font-color:#ffffff;height:300px; border:solid 0.5px #ffffff; border-radius:6px; resize:none;" 
								 name="adcontent" required=""></textarea>								
								 </div>
							  </div>							 
							  <div class="control-group">
								<label class="control-label">广告图片</label>
								<div class="controls">
								  <input name="adpic" class="input-file uniform_on" id="fileInput" type="file" accept="image/*" accept=".png,.gif,.jpg"  multiple>
								</div>
							  </div>							 							 				
