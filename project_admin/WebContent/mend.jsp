	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.jsp"><span>管理员后台管理系统</span></a>
	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>报修报换</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						   <%						
								List<Mend> list = (List<Mend>) request.getAttribute("list");
								for (Mend p : list) {
							...
							<tr>
								...
								<td class="center"><%=p.getVid()%></td>	
								<td class="center"><%=mmtime%></td>															  			
								<td class="center"><%=p.getProblem()%></td>		
								<td class="center">
								<% if (p.getMstate()==0){	 %>
								...
								<%	} else {%>
					           	...
					           	<%	}  %>	
									...
									<a class="btn btn-info" href="MendEditDetail?mendid=<%=rmendid %>">
