					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">						
							...
							<tr>
								...
								<td class="center">
								<textarea readonly style="width:500px;font-size:15px; font-color:#ffffff;height:300px; border:solid 0.5px #ffffff; border-radius:6px; resize:none;"><%=p.getAdcontent() %></textarea>
								<!-- 
								<textarea readonly rows="3" value="<%=p.getAdcontent()%>" ></textarea>	
								 -->							
								</td>	
							</tr>							
							<tr>
