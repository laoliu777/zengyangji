	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>用户信息修改</h2>
						<div class="box-icon">
					...
					<%						
								User p = (User) request.getAttribute("userdetail");
					%>	
					<form  action="UserEdit" method="post" onsubmit="return check(this);">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">						
							<tbody>
							<tr>
								<td class="center">账号</td>
								<td class="center">
								<input type = "hidden" style="BACKGROUND-COLOR:transparent;width:8rem;" name = "account" value="<%=p.getAccount()%>" >
		            			<%=p.getAccount()%>
								</td>							
							</tr>
							<tr>
								<td class="center">角色</td>
								<input type = "hidden" style="BACKGROUND-COLOR:transparent;width:8rem;" name = "role" value="<%=p.getRole()%>" >						
								<%  if(p.getRole()==0){%>
							...
							<tr>
								<td>*电话</td>
								<td class="center">
								<input type = "text" name = "tel" style="width:8rem;" maxlength = "11" value="<%=p.getTel()%>" required="">
								</td>										
							</tr>							
						  </tbody>
					  </table>            
					  <div class="form-actions">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="btn" onclick = "return confirm ('确认取消?'),location = 'UserServlet'">取消</button>
					  </div>
					  </form>
					</div>
				</div><!--/span-->
