...
<!-- start: Header -->
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<font size="5rem">提交成功！</font></span><br><br>
		    ...
		    <button class="btn btn-primary" style="height:4rem;"onclick = "javascrtpt:window.location.href='InfoServlet'">
		    <span class="glyphicon glyphicon-hand-left"><font size="4rem">&nbsp;返回设备型号界面&nbsp;&nbsp;</font></span></button>
