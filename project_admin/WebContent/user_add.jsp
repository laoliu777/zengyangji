			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="UserAdd" onsubmit="return check(this)">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">账号</label>
								<div class="controls">
								<input type = "text" name = "account" style="width:8rem;" value="" required="" >
								</div>
							  </div>	
							  <div class="control-group">
								<label class="control-label" for="focusedInput">电话</label>
								<div class="controls">
								<input type = "text" name = "tel" style="width:8rem;" maxlength = "11" value="" required="">
								</div>
							  </div>
							  <div class="control-group">
