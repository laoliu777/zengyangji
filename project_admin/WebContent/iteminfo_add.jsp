			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>设备型号添加</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="InfoAdd" onsubmit="return check(this)">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">型号</label>
								<div class="controls">
								<input type = "text" name = "type" style="width:8rem;" value="" required="" >
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">租赁价（元/天）</label>
								<div class="controls">
								<input type = "text" name = "zujing" style="width:8rem;" value="" required="" >
								</div>
							  </div>			
							  <div class="control-group">
								<label class="control-label" for="focusedInput">租赁押金（元）</label>
								<div class="controls">
								<input type = "text" name = "yajing" style="width:8rem;" value="" required="">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">销售价（元）</label>
								<div class="controls">
								<input type = "text" name = "shoujia" style="width:8rem;" value="" required="">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">品牌</label>
								<div class="controls">
								<input type = "text" name = "brand" style="width:8rem;" value="" required="">
								</div>
							  </div>	
							  <div class="control-group">
								<label class="control-label" for="focusedInput">规格1</label>
								<div class="controls">
								<input type = "text" name = "spec1" style="width:8rem;" value="" required="">
								KM
								</div>
							  </div>	
							  <div class="control-group">
								<label class="control-label" for="focusedInput">规格2</label>
								<div class="controls">
								<input type = "text" name = "spec2" style="width:8rem;" value="" required="">
								V
								</div>
							  </div>		 					  						 				
