	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>用户管理</h2>
						<div class="box-icon">
						  ...
						  <tbody>
						   <%						
							...
							<tr>
								...
								<!-- 					  								
								<td class="center">
									<a class="btn btn-info" href="UserEditDetail?role=<%=urole %>&account=<%=uaccount %>">
