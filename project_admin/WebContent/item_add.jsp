						...
						<form class="form-horizontal" action="ItemAdd" onsubmit="return check(this)">
							...
							%>		
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								<input type = "hidden" style="BACKGROUND-COLOR:transparent;" name = "renttime" value="<%=p.getRenttime()%>" >	
								<%=p.getMember()%>
								</div>
							  </div>			
							  <div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								<input type = "text" name = "imei1" style="width:5rem;" value="" maxlength=5>-
								<input type = "text" name = "imei2" style="width:5rem;" value="" maxlength=5>-
								<input type = "text" name = "imei3" style="width:5rem;" value="" maxlength=5>-
								<input type = "text" name = "imei4" style="width:5rem;" value="" maxlength=5>
								</div>
							  </div>							  			  							  						 							 				
