	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>设备型号修改</h2>
						<div class="box-icon">
					...
					<%						
								Info p = (Info) request.getAttribute("infodetail");
								String sspec=p.getSpec();
								String sspec1=sspec.substring(0, 3);
								String sspec2=sspec.substring(6, 9);

					%>	
					<form  action="InfoEdit" method="post" onsubmit="return check(this);">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">						
							<tbody>
							<tr>
								<td class="center">型号</td>
								<td class="center">
								<input type = "hidden" style="BACKGROUND-COLOR:transparent;width:8rem;" name = "account" value="<%=p.getType()%>" >
		            			<%=p.getType()%>
								</td>							
							</tr>
							<tr>
								<td>*租赁价</td>
								<td class="center">
								<input type = "text" name = "zujing" style="width:8rem;"  value="<%=p.getZujing()%>" required="">元/天
								</td>										
							</tr>			
							<tr>
								<td>*租赁押金</td>
								<td class="center">
								<input type = "text" name = "yajing" style="width:8rem;"  value="<%=p.getYajing()%>" required="">元
								</td>										
							</tr>			
							<tr>
								<td>*销售价</td>
								<td class="center">
								<input type = "text" name = "shoujia" style="width:8rem;"  value="<%=p.getShoujia()%>" required="">元
								</td>										
							</tr>			
							<tr>
								<td>*品牌</td>
								<td class="center">
								<input type = "text" name = "brand" style="width:8rem;"  value="<%=p.getBrand()%>" required="">
								</td>										
							</tr>		
							<tr>
								<td>*规格1</td>
								<td class="center">
								<input type = "text" name = "spec1" style="width:8rem;"  value="<%=sspec1%>" required="">KM
								</td>										
							</tr>		
							<tr>
								<td>*规格2</td>
								<td class="center">
								<input type = "text" name = "spec2" style="width:8rem;"  value="<%=sspec2%>" required="">V
								</td>										
							</tr>							
						  </tbody>
					  </table>            
					  <div class="form-actions">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button class="btn" onclick = "return confirm ('确认取消?'),location = 'InfoServlet'">取消</button>
					  </div>
					  </form>
					</div>
				</div><!--/span-->
