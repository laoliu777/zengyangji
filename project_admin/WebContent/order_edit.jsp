	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>订单修改</h2>
						<div class="box-icon">
					...
					String ooid=ooid1+String.format("%05d",p.getOid());
					%>	
					<form  action="OrderEdit" method="post" onsubmit="return check(this);">
